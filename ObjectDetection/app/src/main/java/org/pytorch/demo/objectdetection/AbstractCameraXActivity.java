...
public abstract class AbstractCameraXActivity<R> extends BaseModuleActivity {
    ...
    private void setupCameraX() {
        ...
        final PreviewConfig previewConfig = new PreviewConfig.Builder().setTargetResolution(new Size(2560, 1440)).setTargetAspectRatio(Rational.ZERO).setLensFacing(CameraX.LensFacing.BACK).build();
        ...
        imageAnalysis.setAnalyzer((image, rotationDegrees) -> {
            if (SystemClock.elapsedRealtime() - mLastAnalysisResultTime < 600) {
                return;
            }
